    ...
    <body style="background : url(<?=base_url('public/img/background-tea-default.png')?>) center repeat-y">
        ...
        <div class="container-default p10">
            <?php if($this->cart->total_items() == 0){ ?>
                <div class="row" style="color : #c4c4c4">
                    ...
                    <div class="col-md-12" style="text-align : center;font-size : 24px;font-weight : bold">
                        <a href="<?=base_url("")?>" class="btn btn-success">Quay về trang chủ</a>
                    </div>
                </div>
            <?php }else{ ?>
                        ...
                        <div style="height : fit-content;background : #f4f4f4;padding : 10px">
                            <table class="w100">
                                <tr style="line-height : 3">
                                    ...
                                    <td style="text-align : right"><?=number_format($this->cart->total())?></td>
                                </tr>
                                <tr>
                                ...
                                <tr style="line-height : 3">
                                    ...
                                    <td style="text-align : right;font-size : 24px;color : red"><?=number_format($this->cart->total())?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
