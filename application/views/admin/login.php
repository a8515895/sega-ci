...
<html lang="en">
    ...
    <body style="background : url(<?=base_url("public/img/green-tea.png")?>) no-repeat">
        <div class="container">
            <div class="card card-container">
                <img id="profile-img" class="profile-img-card" src="<?=base_url("public/img/avatar_2x.png")?>" />
                <p id="profile-name" class="profile-name-card"></p>
                <form class="form-signin" action="<?=base_url("verify/login")?>" method="POST">
...
<script>
    $(document).ready(function(){
        $("form").submit(function(){
            if($("input[name='username']").val() != null && $("input[name='password']" != null).val()){
                return true
            }
            return false;
        })
